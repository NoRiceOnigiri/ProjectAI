...
Цель проекта – построить мультиклассовую модель машинного обучения, которая предсказывает уровень риска выгорания у студентов в зависимости от использования искусственного интеллекта (ИИ) в процессе обучения. 
...
| `$R^2$` | Оценивает, насколько хорошо модель объясняет вариативность искомой переменной |
...
| Model | Accuracy | Weighted F1 | MAE | RMSE | $R^2$ |
|---|---|---|---|---|---|
| Logistic Regression | 0.5176 | 0.5032 | 0.5467 | 0.8218 | -0.1826 |
| Random Forest | 0.5207 | 0.5210 | 0.5266 | 0.7881 | -0.0876 |
| LightGBM | 0.5277 | 0.5289 | 0.5112 | 0.7674 | -0.0313 |
